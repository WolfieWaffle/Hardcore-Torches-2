...
public class ModConfig {
	...
	public static void init(FMLPreInitializationEvent event) {
		...
		configCraftCokeTorches = config.getBoolean("enable crafting coke torches", Configuration.CATEGORY_GENERAL, false, "Enable coke torches. Requires a mod that adds oreDictionary coal coke.");
