...
public class HardcoreTorches {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		configTorchCokeFuel = config.getInt("configTorchCokeFuel", Configuration.CATEGORY_GENERAL, 2000, 1, Integer.MAX_VALUE, "The max duration of a coke torch in seconds. Might not update already placed torches.");
		...
		configRegCokeTorches = config.getBoolean("configRegCokeTorches", Configuration.CATEGORY_GENERAL, false, "Enable coke torches. Requires a mod that adds oreDictionary coal coke.");
